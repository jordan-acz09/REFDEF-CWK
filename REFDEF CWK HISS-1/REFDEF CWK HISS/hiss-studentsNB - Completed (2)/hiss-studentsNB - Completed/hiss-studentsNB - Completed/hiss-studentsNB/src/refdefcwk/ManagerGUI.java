...
public class ManagerGUI 
{
    ...
    private JButton teamSizeBtn = new JButton("List Team Size"); 
    ...
    {    
        ...
        teamSizeBtn.addActionListener(new TeamSizeHandler());
...
// Button handlers
   ...
   private class TeamSizeHandler implements ActionListener
{
    public void actionPerformed(ActionEvent e)
    {
        int size = mg.getTeamSize();
        JOptionPane.showMessageDialog(myFrame, "Current team size: " + size);
    }
}
}
